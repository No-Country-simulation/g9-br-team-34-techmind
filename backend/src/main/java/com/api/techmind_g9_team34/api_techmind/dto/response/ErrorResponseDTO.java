 ...
 *
 * <p>Toda respuesta de error de la API sale con esta forma, sin excepción. El
 * {@code GlobalExceptionHandler} (TM-020) es el único lugar que construye
 * instancias de este DTO.
 *
