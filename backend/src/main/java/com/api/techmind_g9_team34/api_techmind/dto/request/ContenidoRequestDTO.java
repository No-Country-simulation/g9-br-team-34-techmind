 ...
 * Bean Validation y se disparan con {@code @Valid} en el parámetro del
 * controlador. No agregar validaciones manuales en el controlador: si una
 * regla no se puede expresar de forma declarativa, va en la capa de servicio.
 *
...
public record ContenidoRequestDTO(
     ...
     * al deserializar. Un título con espacios al inicio o al final es el mismo
     * título, y esto evita que se guarden variantes con diferencias invisibles
     * que después rompan comparaciones o búsquedas.
     *
